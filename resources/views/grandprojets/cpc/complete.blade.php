...
<div class="container">
  <div class="d-flex justify-content-between align-items-center mb-3">
    <h3 class="mb-0">Compléter — {{ $grandProjet->numero_dossier }}</h3>
    <a href="{{ route('chef.grandprojets.cpc.index') }}" class="btn btn-light">Retour</a>
  </div>
  ...
  <div class="card shadow-sm">
    <div class="card-body">
      ...
      <form id="bsCompleteForm" method="POST" action="{{ route('chef.grandprojets.cpc.complete.store', $grandProjet) }}">
        @csrf @method('PUT')
        ...
        <div class="d-flex justify-content-end gap-2 mt-4">
          ...
          <a href="{{ route('chef.grandprojets.cpc.index') }}" class="btn btn-outline-secondary">Annuler</a>
        </div>
      </form>
    </div>
  </div>
